...
const Programs = () => {
  const programs = [
    { _id: '1', title: 'Yoga and Mindfulness Programs', description: 'Enhance your physical and mental well-being with our expert-led yoga and mindfulness sessions.', imageUrl: campus7 },
    { _id: '2', title: 'Environmental Programs', description: 'Engage in sustainability initiatives and learn about environmental conservation.', imageUrl: campus7 },
    { _id: '3', title: 'Cultural Programs', description: 'Celebrate diversity with various cultural events, arts, and traditions.', imageUrl: campus6 }
  ];
      ...
      <div className="relative pt-32 pb-24 bg-blue-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tight drop-shadow-lg">
            Academic <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500">Programs</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {programs.map((program, index) => (
            ...
            >
              ...
              <div className="p-6 pb-8 flex flex-col relative bg-white">
                <h2 className="text-xl font-black text-gray-900 mb-2 group-hover:text-blue-700 transition-colors">
                  {program.title}
                </h2>
